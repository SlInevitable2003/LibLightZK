...
public:
    ...
    __device__ void to_affine() { *this = affine_t(*this); }
    ...
    __device__ static void aadd(jacobian_t& out, const jacobian_t& p1,
                                      const jacobian_t& p2)
    {
        jacobian_t p3;          /* starts as (U1, S1, zz) from addition side */
        struct { field_t H, R, sx; } add, dbl;
    ...
    __device__ inline void aadd(const jacobian_t& p2)
    {   aadd(*this, *this, p2);   }
